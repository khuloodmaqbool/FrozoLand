...
export default function Home() {
    ...
    const filteredProduct = products.filter((crnt)=>{
    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 py-20 w-11/12 mx-auto">
        ...
        <div className="my-auto">
          <h5 className="text-white w-fit border-b-2 border-white">New Cup Icecream</h5>
      ...
      <div className="my-auto ms-6">
          <h5 className="text-white w-fit border-b-2 border-white">Our Top Selling</h5>
          <h2 className="md:text-6xl text-5xl my-3 font-black text-white">
            POPULAR <br />
            ICE CREAM
          </h2>
  ...
  <div className="my-auto" >
    <h5 className="text-white text-2xl border-b-2 w-fit border-white">On Sunday Special</h5>
    <h2 className="md:text-6xl text-5xl font-black text-white my-6">
      BUY 2 GET 1 <br />
      FREE
    </h2>
    <button className="text-white text-3xl outline-none border-b-2 border-white">GET NOW</button>
  </div>
